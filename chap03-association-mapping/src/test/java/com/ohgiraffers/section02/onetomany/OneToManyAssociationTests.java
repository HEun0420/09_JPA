...
public class OneToManyAssociationTests {
    ...
    @Test
    @DisplayName("일대다 연관관계 객쳋 그래프 탐색을 이용한 조회 테스트")
    public void test1() {
    ...
    public void test2() {
        ...
        categoryAndMenu.setCategoryCode(999);
        ...
        //then
        CategoryAndMenu foundeCategoryAndMenu = entityManager.find(CategoryAndMenu.class, 888);

        System.out.println(foundeCategoryAndMenu);
